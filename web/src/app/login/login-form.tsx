  ...
  return (
    <div className="rounded-2xl border border-gray-800 bg-gray-900 p-6 shadow-theme-xl">
      ...
      <button
        ...
        disabled={cargando}
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-700 bg-gray-800 py-2 text-sm font-medium text-white transition hover:bg-gray-700 disabled:opacity-50"
      >
        <GoogleIcon />
